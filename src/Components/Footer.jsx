...
function Footer() {
  return (
    <div className="w-full flex gap-5 h-screen px-16 py-12 font-['Founders_Grotesk_X-Cond Bold']">
      <div className="w-1/2 flex flex-col h-full justify-between">
        <div className="heading">
          <h1 className="text-[7vw] leading-[6.5vw] -mb-1 tracking-tighter uppercase font-bold">
            Eye-
          </h1>
          <h1 className="text-[7vw] leading-[6.5vw] tracking-tighter uppercase font-bold">
            Opening
          </h1>
        </div>
        <svg
      ...
      <div className="w-1/2">
        <div className="heading">
        <h1 className="text-[6vw] leading-[6.5vw] -mb-1 tracking-tighter  uppercase font-bold">
            presentations
          </h1>
        </div>
